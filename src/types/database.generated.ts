//src/types/database.generated.ts (backup)
...
// Generated after adding features table
// ============================================
...
// Features table (now exists in database!)
...
// User and profile types (note: no 'users' table, use 'profiles')
...
// Comparison data structure used in your components
export type ComparisonData = {
  vendor: Vendor
  plans: Plan[]
  prices: PriceFact[]
  features: Feature[] // Now properly typed!
}
...
// Plan with all related data
export type PlanWithPricing = Plan & {
  price_facts: PriceFact[]
  features: Feature[]
}

// Extended plan with all details
